...
class LSTMEncoder(nn.Module):
    # <-- MODIFIED: Changed in_dim from 4 to 6
...
def main_train():
    ...
    print("Creating weather features (sunny, rainy)...")
    ...
    # The classes now default to in_dim=6, so this initialization works
    lstm = LSTMEncoder()
    gnn = GNNEncoder()
