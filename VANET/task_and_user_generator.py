...
class Config:
    ...
    class TaskConfig:
        ...
        CYCLES_PER_BIT_OPTIONS = [500, 750, 1000, 1250, 1500]
    ...
    class VehicleConfig:
        ...
        LOW_TRANSMISSION_POWER = 5  # todo : it's homogeneous right now and it's good to make it heterogeneous
        ...
        USER_NODE_FREQUENCY=10
        MOBILE_NODE_FREQUENCY=20
...
class Generator:
    ...
    def generate_one_step_task(step, vehicle, lane_counter):
        ...
        cycles_per_bit = random.choice(Config.TaskConfig.CYCLES_PER_BIT_OPTIONS)
        chance = random.random()
        threshold = Config.VehicleConfig.TASK_GENERATION_RATE
        dataSize = round(random.uniform(500, 2000), 2)
        if (
