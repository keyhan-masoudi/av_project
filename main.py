...
from controllers.Simulator.simulator_mappo import SimulatorMAPPO
...
def run_one(params):
    ...
    elif Config.ZoneManagerConfig.DEFAULT_ALGORITHM == Config.ZoneManagerConfig.ALGORITHM_MAPPO:
        simulator = SimulatorMAPPO(loader, Clock(), cloud)
