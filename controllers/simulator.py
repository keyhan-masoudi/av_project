...
class Simulator:
    ...
    def init_simulation(self):
        ...
        if hasattr(self.metrics, 'reset'): self.metrics.reset()  # Reset metrics if method exists
    ...
    def start_simulation(self):
        ...
        while (current_time := self.clock.get_current_time()) < Config.SimulatorConfig.SIMULATION_DURATION:
            ...
            traffic_data = UtilsFunc.recognize_traffic_status(
                f"D:\code\VANET - Copy\SumoDividedByTime\Outputs2\dataInTime{int(self.clock.get_current_time())}.csv",
                partitions
            )
            ...
            self.save_missed_deadlines_to_excel(
                f"missed_deadlines_report_{Config.ZoneManagerConfig.DEFAULT_ALGORITHM}_{Config.NoiseMethod.DEFAULT_METHOD}_{Config.NoiseConfig.DEFAULT_THRESHOLD}_{Config.TrafficNoise.DEFAULT_TrafficNoiseLevel}_{Config.AttenuationLevel.DEFAULT_AttenuationLevelName}.xlsx")
            self.save_success_deadlines_to_excel(
                f"success_deadlines_report_{Config.ZoneManagerConfig.DEFAULT_ALGORITHM}_{Config.NoiseMethod.DEFAULT_METHOD}_{Config.NoiseConfig.DEFAULT_THRESHOLD}_{Config.TrafficNoise.DEFAULT_TrafficNoiseLevel}_{Config.AttenuationLevel.DEFAULT_AttenuationLevelName}.xlsx")
            self.metrics.save_to_excel(
                f"final_metrics_summary_{Config.ZoneManagerConfig.DEFAULT_ALGORITHM}_{Config.NoiseMethod.DEFAULT_METHOD}_{Config.NoiseConfig.DEFAULT_THRESHOLD}_{Config.TrafficNoise.DEFAULT_TrafficNoiseLevel}_{Config.AttenuationLevel.DEFAULT_AttenuationLevelName}.xlsx")
